The project aims to compute which playlist ,in an array of objects that contain song information, belongs to a given guardian in an object of guardians that have their own genre.
